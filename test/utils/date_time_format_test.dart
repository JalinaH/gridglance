...
void main() {
  test('formatLastUpdatedAgo returns human-friendly relative labels', () {
    ...
    expect(
      formatLastUpdatedAgo(now.subtract(const Duration(seconds: 40)), now: now),
      'Last updated just now',
    );
    expect(
      formatLastUpdatedAgo(now.subtract(const Duration(minutes: 1)), now: now),
      'Last updated 1 min ago',
    );
    expect(
      formatLastUpdatedAgo(now.subtract(const Duration(minutes: 42)), now: now),
      'Last updated 42 mins ago',
    );
    expect(
      formatLastUpdatedAgo(now.subtract(const Duration(hours: 3)), now: now),
      'Last updated 3 hours ago',
    );
    expect(
      formatLastUpdatedAgo(now.subtract(const Duration(days: 2)), now: now),
